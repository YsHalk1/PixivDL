...
- **Просмотр Pixiv** — лента, поиск, рекомендации, подписки, история, коллекции, страницы авторов.
- **Скачивание работ** — менеджер скачиваний с прогрессом и уведомлениями.
- **Умный кэш** — предзагрузка и кэширование изображений для быстрого листания.
- **Виджеты** — `1×1` и `2×2` с автообновлением картинки.
- **Отправка в Telegram** — привязка собственного бота (токен вводит пользователь) и отправка работ в чат/канал.
...
> Этот проект не аффилирован с Pixiv Inc. Используйте
> в соответствии с условиями использования Pixiv.
